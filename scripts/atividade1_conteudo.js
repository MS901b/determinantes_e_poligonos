		...
		parte1_q1: //Questão 1
		{
			...
			[
				{//A
					...
					antes: 'Det =',
					msgErro: 'Lembre-se que o valor do determinante é dado por: X<sub style="color:red">p</sub>*Y<sub style="color:red">q</sub> - X<sub style="color:red">q</sub>*Y<sub style="color:red">p</sub>'
				},
				{//B
					tipo: 'input',
		...
		parte1_q2:
		{
			...
			[
				{//A
					...
					msgErro: 'Lembre-se que a área é uma quantidade, logo, deverá ser positiva e seu valor é dado pelo determinante: X<sub style="color:red">p</sub>*Y<sub style="color:red">q</sub> - X<sub style="color:red">q</sub>*Y<sub style="color:red">p</sub>'
				}
			]
		}
	}
